...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    final activeProgramCount = dummyPrograms.where((p) => p.status == 'In progress').length;
    final overallProgress =
        (dummyPrograms.fold<int>(0, (sum, p) => sum + p.progressPercent) /
          ...
          child: Column(
            ...
            children: [
              ...
              ...dummyPrograms
                  ...
                  .take(2)
                  .map((program) => _buildRecommendationTile(context, program))
                  .toList(),
